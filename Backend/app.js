...
var gustarEvento = new Evento({
    ...
    personas:0,
    precioE:600,
    precios: [{nombre:'S.ORQUESTA', precio:'1450 + 160'},
    {nombre:'PLATEA BAJA', precio:'1300 + 145'},
    {nombre:'PLATEA ALTA', precio:'1150 + 125'},
    {nombre:'TERTULIA BALCON', precio:'1000 + 110'},
    {nombre:'TERTULIA ALTA', precio:'850 + 95'},
    {nombre:'GRADAS CENTRALES', precio:'700 + 80'},
    {nombre:'GRADA IZQUIEDA', precio:'700 + 80'},
    {nombre:'GRADA DERECHA', precio:'700 + 80'},
    {nombre:'PARAISO S/N', precio:'600 + 65'}],
...
var inviEvento = new Evento({
    ...
    personas:0,
    precioE:860,
    precios: [{nombre:'ULTRA VIP', precio:'1380 + 140'},
    {nombre:'PALCO VIP ORO', precio:'1180 + 120'},
    {nombre:'PALCO VIP PLATA', precio:'980 + 100'},
    {nombre:'GENERAL', precio:'780 + 80'}],
...
var richieEvento = new Evento({
    ...
    personas:0,
    precioE:1250,
    precios: [{nombre:'GENERAL', precio:'1135 + $115'},
    {nombre:'2X1 LA NACION GENERAL', precio:'1135 + $230'},
    {nombre:'2X1 CLARIN 365 GENERAL', precio:'1135 + $230'}],
...
var disneyEvento = new Evento({
    ...
    personas:0,
    precioE:850,
    precios: [{nombre:'PALCO Para 4 personas', precio:'14800 + 2220'},
    {nombre:'SUPER PULLMAN A', precio:'2900 + 435'},
    {nombre:'PLATEA PREFERIDA', precio:'2500 + 375'},
    {nombre:'SUPER PULLMAN', precio:'1700 + 255'},
    {nombre:'PLATEA MADERO BAJA', precio:'1600 + 240'},
    {nombre:'PLATEA CENTRAL', precio:'1400 + 210'},
    {nombre:'PULLMAN', precio:'1300 + 195'},
    {nombre:'PLATEA', precio:'850 + 130'},
    {nombre:'PLATEA MADERO ALTA', precio:'850 + 130'},
    {nombre:'CABECERA S/N', precio:'450 + 70'}],
...
var wweEvento = new Evento({
    ...
    rating:3.5,
    precioE:1000,
    precios: [{nombre:'RING SIDE', precio:'3500 + 420'},
    {nombre:'SUPER PULLMAN', precio:'3000 + 360'},
    {nombre:'MEET & GREET', precio:'3000 + 360'},
    {nombre:'RING SIDE ALTO', precio:'2400 + 290'},
    {nombre:'PLATEA MADERO ALTA', precio:'1700 + 205'},
    {nombre:'CABECERA S/N', precio:'1000 + 120'}],
    personas:0,
    ubicacion:'Luna Park, CABA',
    latitude:-34.602055,
    longitude:-58.368697
...
var tiniEvento = new Evento({
    ...
    personas:0,
    precioE:700,
    precios: [{nombre:'PLATEA VIP', precio:'2500 + 300'},
    {nombre:'SUPER PULLMAN CENTRAL', precio:'2500 + 300'},
    {nombre:'PLATEA ELEVADA', precio:'2200 + 270'},
    {nombre:'SUPER PULLMAN LATERAL', precio:'2000 + 240'},
    {nombre:'PLATEA LATERAL', precio:'1500 + 180'},
    {nombre:'PULLMAN LATERAL', precio:'1100 + 135'},
    {nombre:'CABECERA S/N', precio:'700 + 85'}],
    ubicacion:'Luna Park, CABA',
    latitude:-34.602055,
    longitude:-58.368697
});
...
var sealEvento = new Evento({
    ...
    personas:0,
    precioE:1400,
    precios: [{nombre:'PLATEA VIP', precio:'4000 + 480'},
    {nombre:'SUPER PULLMAN CENTRAL', precio:'3500 + 420'},
    {nombre:'PLATEA ELEVADA', precio:'3100 + 375'},
    {nombre:'SUPER PULLMAN LATERAL', precio:'3100 + 375'},
    {nombre:'PLATEA LATERAL', precio:'2600 + 315'},
    {nombre:'PULLMAN LATERAL', precio:'1900 + 230'},
    {nombre:'CABECERA S/N', precio:'1400 + 170'}],
    ubicacion:'Luna Park, CABA',
    latitude:-34.602055,
    longitude:-58.368697
});
